pada sesi kali ini, saya akan melakukan query optimasi database server yang bisa dilakukan secara rutin untuk menghasilkan data spesifik yang akurat sehingga membuat performa dan perencanaan eksekusi query menjadi lebih optimal. 
